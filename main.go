...
func main() {
	remoteAPIURL := []string{
		"https://www.clarke.com/labels-sds-resource-guides/?fwp_paged=1",
		"https://www.clarke.com/labels-sds-resource-guides/?fwp_paged=2",
		"https://www.clarke.com/labels-sds-resource-guides/?fwp_paged=3",
